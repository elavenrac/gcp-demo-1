...
import tensorflow as tf, apache_beam as beam
...
def get_metadata() -> dataset_metadata.DatasetMetadata:
    return dataset_metadata.DatasetMetadata(dataset_schema.from_feature_spec({'cash':tf.io.FixedLenFeature([], tf.int64), 
